...
### App Entry
- `ClaudeConnectApp.swift` - SwiftUI app entry point
...
- **Xcode Project:** `/Users/aaron/Desktop/max/ios-voice-app/ClaudeConnect/ClaudeConnect.xcodeproj`
- **Deployment Target:** iOS 18.0
- **Info.plist:** Custom plist with microphone and speech recognition permissions
- **Bundle ID:** bandwich.ClaudeConnect
...
**iOS App:**
- Xcode Project: `/Users/aaron/Desktop/max/ios-voice-app/ClaudeConnect/ClaudeConnect.xcodeproj`
- Source Files: `/Users/aaron/Desktop/max/ios-voice-app/ClaudeConnect/ClaudeConnect/`
...
2. **Build and run the app:**
   - Open `ClaudeConnect.xcodeproj` in Xcode
