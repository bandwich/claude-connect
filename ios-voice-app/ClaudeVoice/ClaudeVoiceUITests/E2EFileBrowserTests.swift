...
final class E2EFileBrowserTests: E2ETestBase {
    ...
    func test_expand_directory() throws {
        ...
        let folderButton = app.buttons.matching(NSPredicate(format: "label CONTAINS 'test_folder' OR label CONTAINS 'voice_server' OR label CONTAINS 'ios-voice-app'")).firstMatch
