...
```bash
cd voice_server/tests && ./run_tests.sh           # all tests
...
| Test | Tests |
|------|-------|
| `test_ios_server.py` | VoiceServer, TranscriptHandler core |
...
Located in `ios-voice-app/ClaudeVoice/ClaudeVoiceUITests/`. Run via `run_e2e_tests.sh`.
