...
from server.services.tts_manager import TTSManager, warmup_tts
from server.services.transcript_watcher import TranscriptHandler, poll_for_session_file
from server.handlers.file_handler import FileHandler
from server.handlers.input_handler import InputHandler
from server.models.content_models import AssistantResponse
from server.services.session_manager import SessionManager
from server.services.usage_checker import UsageChecker
from server.infra.tmux_controller import TmuxController, session_name_for
from server.models.session_context import SessionContext, MAX_ACTIVE_SESSIONS
from server.services.permission_handler import PermissionHandler
from server.services.commands_provider import CommandsProvider
...
class ConnectServer:
    ...
    def __init__(self):
        ...
        set_server(self)  # Enable HTTP endpoints to access server state
    ...
    async def poll_claude_ready(self, tmux_name: str = None, timeout: float = 15.0, interval: float = 0.3) -> bool:
        ...
        """
        from server.infra.pane_parser import is_claude_ready
