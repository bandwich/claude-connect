# server/tests/test_http_server.py
...
from server.infra.http_server import create_http_app, set_server, _server
...
class TestSessionFiltering:
    ...
    def test_no_server_allows_through(self):
        """When server isn't set, allow through for backward compat."""
        from server.infra.http_server import is_viewed_session
        set_server(None)
